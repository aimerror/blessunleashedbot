...
log_message("Starting bot in 3 seconds")
time.sleep(1)
log_message("Starting bot in 2 seconds")
time.sleep(1)
log_message("Starting bot in 1 seconds")
time.sleep(1)
...
while True:
    ...
    while(waiting_for_hook):
        ...
        locations = list(zip(*locations[::-1]))
        if locations:
            log_message("Invalid location, moving camera")
            ...
            if locations:
                ...
                for (direction, position) in zip(quicktime_directions, quicktime_positions):
                    ...
                    if r > 216 and g > 165 and b < 55:
                        log_message("Press up: "+ direction)
